...
module Exercise11_02 =
    ...
    type Message = 
        {FileName : string; Content : float[] }

    type Reading =
        {TimeStamp : DateTimeOffset; Data : float[] }

    let example =
        [|
            { FileName = "2019-02-23T02:00:00-05:00"; Content = [|1.0; 2.0; 3.0; 4.0|] }
            { FileName = "2019-02-23T02:00:10-05:00"; Content = [|5.0; 6.0; 7.0; 8.0|] }
            { FileName = "error"; Content = [||] }
            { FileName = "2019-02-23T02:00:20-05:00"; Content = [|1.0; 2.0; 3.0; Double.NaN|] }
        |]
