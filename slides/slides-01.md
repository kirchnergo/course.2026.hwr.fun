...
-   Termine
    -   [18.02, 25.02, 04.03, 18.03, 25.03]
-   Bewertung
    -   .50: Hausaufgaben (10)
    -   .25: Programmieraufgabe (in der vorvorletzten Einheit)
    -   .25: Test (multiple choice, in der letzten Einheit)
-   Folien und Code auf [github.com/kirchnergo/course.2026.hwr.fun](https://github.com/kirchnergo/course.2026.hwr.fun)
...
<tbody>
<tr>
<td class="org-left">1.108.1</td>
</tr>

<tr>
<td class="org-left">585eba7c0c34fd6b30faac7c62a42050bfbc0086</td>
</tr>
...
-   Initialisiere ein git-Repo (z.B. `course.2026.hwr.fun`)
    -   (pull von github)
    -   Committe eine Änderung
    -   Betrachte die Historie
    -   (push nach github)
-   clone [github.com/kirchnergo/course.2026.hwr.fun](https://github.com/kirchnergo/course.2026.hwr.fun)
...
## Unendliche Sequenzen :)
    ...
    firstTenRandomNumbers;;
    val it: int list =
      [9208; 13158; 22449; 52502; 53966; 61908; 65806; 65849; 85519; 94285]
...
## Mapping (2)
    ...
    val ps: (string * string) list =
      [("http://www.bing.com",
        "<!doctype html><html lang="de" dir="ltr"><head><meta name="th"+[58249 chars]);
       ("http://www.google.com",
        "<!doctype html><html itemscope="" itemtype="http://schema.org"+[50375 chars])]
    val ls: int list = [58310; 50436]
    val it: unit = ()
...
## Basics
    ...
    val listOfFunctions: (int -> int) list =
      [<fun:listOfFunctions@884-6>; <fun:listOfFunctions@884-7>]
    val it: unit = ()
...
-   exercism.io (E-Mail bis 23.02, mit *account*!)
    -   [ ] Two-Fer
    -   [ ] Leap
    -   [ ] Isogram
    -   [ ] Sum Of Multiples
