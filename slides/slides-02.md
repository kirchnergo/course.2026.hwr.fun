...
## Große Zahlen (Lösung)
    ...
    #time "off"
    printfn "Length = %d, digits %s ... %s" l prefix suffix;;
    Real: 00:00:00.768, CPU: 00:00:00.755, GC gen0: 0, gen1: 0, gen2: 0
    val sans: string =
...
## Option
    ...
    /Users/kirchnerg/Desktop/courses/course.2026.hwr.fun/slides/stdin(1428,34): error FS0039: The type 'BillingDetails' is not defined.
...
## Option
    ...
    /Users/kirchnerg/Desktop/courses/course.2026.hwr.fun/slides/stdin(1437,13): error FS0039: The value or constructor 'order1' is not defined.
...
## Result (Imperativ)
    ...
    System.ArgumentException: Must not be white space
       at FSI_0367.checkString(String s) in /Users/kirchnerg/Desktop/courses/course.2026.hwr.fun/slides/stdin:line 1447
       at <StartupCode$FSI_0367>.$FSI_0367.main@() in /Users/kirchnerg/Desktop/courses/course.2026.hwr.fun/slides/stdin:line 1452
...
## Result (Error-Types DU)
    ...
    val it:
      ...
      (<fun:it@1478-92>, Error MustNotBeNull, Error MustNotBeEmpty,
